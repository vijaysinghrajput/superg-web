  ...
  useEffect(() => {
    if (products.length != 0) {
      const filteredClubs = products.filter((Club) => {
        let ClubLowercase = Club.product_name.toLowerCase();
  ...
  return (
    <>
                  ...
                  <div class="rounded shadow bg-success p-3 text-white">
                    <div class="d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        ...
                        />
                        <h6 class="m-0 ml-2">
                          {cartItems.length} items. ₹{Math.round(GetTotal)}
                        </h6>
                      </div>{" "}
                      <h6 className="ml-auto mb-0 d-flex">
                        view cart <MdArrowForwardIos />
                      </h6>
                    </div>
                  </div>
                </Link>
            ...
            pathname !== "/saveMyAddress" && (
              <div class="osahan-menu-fotter fixed-bottom bg-white text-center border-top">
                <div class="row m-0">
                  <Link
                    ...
                    class={
                      pathname === "/"
                        ...
                        : "text-muted col small text-decoration-none p-2"
                    }
                  >
                    <p class="h5 m-0">
                  ...
                  <a
                    href={`https://api.whatsapp.com/send?text=Hello SuperG.in!&phone=${constants.phone}`}
                    class={
                      pathname === "/offers"
                        ? "text-dark small col font-weight-bold text-decoration-none p-2 selected"
                        : "text-muted col small text-decoration-none p-2"
      ...
      {!isNotSmallerScreen && pathname !== "/" ? (
        <div
          class="p-3 border-bottom mobile-nav"
          style={{ background: "#fff", boxShadow: "0 1px 5px 0px #dadada" }}
        >
          <div class="d-flex align-items-center justify-content-between">
            <div className="d-flex align-items-center">
              <div
              ...
              <a
                class="ml-auto hc-nav-trigger hc-nav-1"
                href="#"
                onClick={onOpen}
              >
        ...
        <div
          class="border-bottom p-3 d-none mobile-nav"
      ...
      <div
        class="bg-white shadow-sm osahan-main-nav position-fixed w-100"
        style={{ zIndex: 99 }}
      >
        <nav class="navbar navbar-expand-lg navbar-light bg-white osahan-header py-0 container">
          <Link class="navbar-brand mr-0" to="/">
            <img
          ...
          <div class="ml-3 d-flex align-items-center">
            <div class="dropdown mr-3">
              <a
                class="text-dark dropdown-toggle d-flex align-items-center osahan-location-drop"
                href="#"
              >
                <div>
                  <i class="icofont-location-pin d-flex align-items-center bg-light rounded-pill p-2 icofont-size border shadow-sm mr-2"></i>
                </div>
                <div>
                  <p class="text-muted mb-0 small">Delivery Area</p>
                  <Select
                      ...
                      return (
                        ...
                        >
                          <div>
                            ...
                            />{" "}
                            {item.product_name}{" "}
                            <small className="mr-2">{item.hindi_name}</small>
            ...
            <ul class="list-unstyled form-inline mb-0">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a
                    href={`https://api.whatsapp.com/send?text=Hello SuperG.in!&phone=${constants.phone}`}
                    className="orderOnBlock dropdown-item d-flex align-items-center mb-2"
                    style={{ color: "green" }}
                  >
                    <BsWhatsapp />
                  ...
                  <a
                    ...
                    className="orderOnBlock dropdown-item d-flex align-items-center"
                    style={{ color: "blue" }}
                  >
                    <BsFillTelephoneFill />
