...
const Login = () => {
  ...
  useEffect(() => {
    const phoneno = /^\d{10}$/;
    userMobileNumber.match(phoneno)
  ...
  const insertUserFun = (userObject) => {
    fetch(URL + "/APP-API/App/InsertUser", {
      ...
      .then((responseJson) => {
        ...
        cookies.set("userProvider_id", responseJson.data[0].provider_id, {
          maxAge: 9999999999,
        });
        cookies.set("userName", responseJson.data[0].name, {
          maxAge: 9999999999,
        });
        cookies.set("userMobile", responseJson.data[0].mobile, {
          maxAge: 9999999999,
        });
            ...
            <div class="col-lg-6">
              {isNotSmallerScreen && (
                <div className="div">
                  <Link
                    to="/"
                    class="text-decoration-none text-dark d-flex align-items-center justify-content-center mb-5"
                  >
