    ...
    <>
      <Box bg="#fff" p={3} borderRadius={5}>
        ...
        <Text mb={2} fontSize={11}>
          ...
          related to it, still belong to SuperG.in.
        </Text>
        <Text mb={2} fontSize={11}>
          SuperG.in is committed to ensuring that the app is as useful and
        ...
        <Text mb={2} fontSize={11}>
          The SuperG.in app stores and processes personal data that you have
          ...
          security features and it could mean that the SuperG.in app won’t work
          properly or at all.
        </Text>
        <Text mb={2} fontSize={11}>
        ...
        <Text mb={2} fontSize={11}>
          You should be aware that there are certain things that SuperG.in will
          ...
          Wi-Fi or provided by your mobile network provider, but SuperG.in
        ...
        <Text mb={2} fontSize={11}>
          Along the same lines, SuperG.in cannot always take responsibility for
          ...
          avail the Service, SuperG.in cannot accept responsibility.
        </Text>
        <Text mb={2} fontSize={11}>
          With respect to SuperG.in’s responsibility for your use of the app,
          ...
          that we can make it available to you. SuperG.in accepts no liability
        ...
        <Text mb={2} fontSize={11}>
          ...
          want to keep using the app. SuperG.in does not promise that it will
