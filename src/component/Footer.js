                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div className="d-flex justify-content-center">
                                    <a className='mx-1' style={{ color: "#000", fontSize: 16 }} href="https://www.facebook.com/supergforgrocery"><BsFacebook /></a>
                                    <a className='mx-1' style={{ color: "#000", fontSize: 16 }} href="https://twitter.com/superg_in"><AiFillTwitterCircle /></a>
                                    <a className='mx-1' style={{ color: "#000", fontSize: 16 }} href="https://www.instagram.com/superg.in/"><AiOutlineInstagram /></a>
                                    <a className='mx-1' style={{ color: "#000", fontSize: 16 }} href="https://www.linkedin.com/company/superg-in/"><AiFillLinkedin /></a>
                                </div>
                            </div>
                            <div class="col-md-4 text-md-right">
                                <a href="https://play.google.com/store/apps/details?id=com.apk.superg"><img src="/img/playmarket.png" height="30" /></a>
                            </div>
                        </div>
                    </div>
                </section>
